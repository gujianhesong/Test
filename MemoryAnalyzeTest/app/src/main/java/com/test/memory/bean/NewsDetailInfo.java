...
public class NewsDetailInfo {
    ...
    private List<NewsInfo> relative_sys;
    ...
    public List<NewsInfo> getRelative_sys() {
        return relative_sys;
    }

    public void setRelative_sys(List<NewsInfo> relative_sys) {
